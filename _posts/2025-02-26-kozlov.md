...
|-------------------------------|-------------------------------------------------------|---------------------------------------------------|
| KozlovDefeated.mp3            | {% include embed-audio.html src="KozlovDefeated.mp3" %} Poraženje vymogaje najličajšego geroizma.           | {% include embed-audio.html src="ISV/KozlovDefeated.mp3" %} Poråzka trěbuje najveličejšego heroizma.          |
| KozlovHateHello.mp3           | {% include embed-audio.html src="KozlovHateHello.mp3" %} Stučit sʲa nišči!                                      | {% include embed-audio.html src="ISV/KozlovHateHello.mp3" %} javjaje sę prośak                                 |
| KozlovHateLetsHearIt01.mp3    | {% include embed-audio.html src="KozlovHateLetsHearIt01.mp3" %} Govori prʲamo!                                        | {% include embed-audio.html src="ISV/KozlovHateLetsHearIt01.mp3" %} Govori prěmo!                                     |
| KozlovHateLetsHearIt02.mp3    | {% include embed-audio.html src="KozlovHateLetsHearIt02.mp3" %} Govori, čto mož govoritʲ!                             | {% include embed-audio.html src="ISV/KozlovHateLetsHearIt02.mp3" %} Govori, čto možeš govoriti!                       |
| KozlovHateLetsHearIt03.mp3    | {% include embed-audio.html src="KozlovHateLetsHearIt03.mp3" %} Ty prinosiš bolš polupravd?                           | {% include embed-audio.html src="ISV/KozlovHateLetsHearIt03.mp3" %} Ty prinosiš vyše polupravd?                       |
| KozlovHateNo01.mp3            | {% include embed-audio.html src="KozlovHateNo01.mp3" %} A korovy načnut lʲetʲatʲ!                             | {% include embed-audio.html src="ISV/KozlovHateNo01.mp3" %} A kråvy budut počęti lětati!                      |
| KozlovHateNo02.mp3            | {% include embed-audio.html src="KozlovHateNo02.mp3" %} Mydlanʲje glaz!                                        | {% include embed-audio.html src="ISV/KozlovHateNo02.mp3" %} myljeńje očij                                     |
| KozlovHateNo03.mp3            | {% include embed-audio.html src="KozlovHateNo03.mp3" %} Ty sošel z rozuma!                                    | {% include embed-audio.html src="ISV/KozlovHateNo03.mp3" %} Ty jesi prosto bezumnik!                          |
| KozlovHateYes01.mp3           | {% include embed-audio.html src="KozlovHateYes01.mp3" %} Tolʲko dlʲa mojej Rodiny.                             | {% include embed-audio.html src="ISV/KozlovHateYes01.mp3" %} Moja otčina trěbuje prijęti tuto                  |
| KozlovHateYes02.mp3           | {% include embed-audio.html src="KozlovHateYes02.mp3" %} Nʲeh budʲe.                                           | {% include embed-audio.html src="ISV/KozlovHateYes02.mp3" %} Nehaj bude.                                       |
| KozlovHateYes03.mp3           | {% include embed-audio.html src="KozlovHateYes03.mp3" %} Ždʲet mʲenʲa obʲet!                                   | {% include embed-audio.html src="ISV/KozlovHateYes03.mp3" %} My budemo zarěkati sę o tom                       |
| KozlovIntro.mp3               | {% include embed-audio.html src="KozlovIntro.mp3" %} Sputnik, Slovʲanska Federacija pozdravjaje(t) tʲebʲa. | {% include embed-audio.html src="ISV/KozlovIntro.mp3" %} Sputniče, Slovjanska Federacija pozdravjaje tebe  |
| KozlovNeutralHello.mp3        | {% include embed-audio.html src="KozlovNeutralHello.mp3" %} Hotʲ poznakomimsʲa.                                    | {% include embed-audio.html src="ISV/KozlovNeutralHello.mp3" %} Finalno, my vidimo jedin drugogo                  |
| KozlovNeutralLetsHearIt01.mp3 | {% include embed-audio.html src="KozlovNeutralLetsHearIt01.mp3" %} Prošu, govori.                                        | {% include embed-audio.html src="ISV/KozlovNeutralLetsHearIt01.mp3" %} Prošu, govori.                                    |
| KozlovNeutralLetsHearIt02.mp3 | {% include embed-audio.html src="KozlovNeutralLetsHearIt02.mp3" %} Podumaj i govori.                                     | {% include embed-audio.html src="ISV/KozlovNeutralLetsHearIt02.mp3" %} Pomysli i govori                                  |
| KozlovNeutralLetsHearIt03.mp3 | {% include embed-audio.html src="KozlovNeutralLetsHearIt03.mp3" %} V prostyh slovah, požalujsta.                         | {% include embed-audio.html src="ISV/KozlovNeutralLetsHearIt03.mp3" %} Prošu, v prostyh slovah                           |
| KozlovNeutralNo01.mp3         | {% include embed-audio.html src="KozlovNeutralNo01.mp3" %} Prošu proščenija?                                     | {% include embed-audio.html src="ISV/KozlovNeutralNo01.mp3" %} Pardon, čto?                                      |
| KozlovNeutralNo02.mp3         | {% include embed-audio.html src="KozlovNeutralNo02.mp3" %} Sožaleju, nʲet.                                         | {% include embed-audio.html src="ISV/KozlovNeutralNo02.mp3" %} Nažalost, ne.                                     |
| KozlovNeutralNo03.mp3         | {% include embed-audio.html src="KozlovNeutralNo03.mp3" %} Ja ne znaju.                                            | {% include embed-audio.html src="ISV/KozlovNeutralNo03.mp3" %} Ja ne znam.                                       |
| KozlovNeutralYes01.mp3        | {% include embed-audio.html src="KozlovNeutralYes01.mp3" %} My zgodny.                                            | {% include embed-audio.html src="ISV/KozlovNeutralYes01.mp3" %} My jesmo suglasni/gotovi.                         |
| KozlovNeutralYes02.mp3        | {% include embed-audio.html src="KozlovNeutralYes02.mp3" %} Konʲečne                                               | {% include embed-audio.html src="ISV/KozlovNeutralYes02.mp3" %} Samorazumno.                                      |
| KozlovNeutralYes03.mp3        | {% include embed-audio.html src="KozlovNeutralYes03.mp3" %} Počemu nʲet.                                           | {% include embed-audio.html src="ISV/KozlovNeutralYes03.mp3" %} Začto by ne.                                      |
| KozlovPeaceful.mp3            | {% include embed-audio.html src="KozlovPeaceful.mp3" %} Naša Očizna v bezogroznosti.                          | {% include embed-audio.html src="ISV/KozlovPeaceful.mp3" %} Naša otčina je v bezgroznosti.                    |
| KozlovRequest.mp3             | {% include embed-audio.html src="KozlovRequest.mp3" %} Torgovlʲa opirass nʲe na potrʲebah, a na spravʲedlivosti. | {% include embed-audio.html src="ISV/KozlovRequest.mp3" %} Trg opiraje sę ne na potrěby, a na spravědlivosť. |
| KozlovAttacked.mp3            | {% include embed-audio.html src="KozlovAttacked.mp3" %} Davajtʲe ohranim našu zemlʲu, ne budem ej niščitʲ!      | {% include embed-audio.html src="ISV/KozlovAttacked.mp3" %} Budemo ohraniti našu zemju, ne budemo ju niščiti. |
| KozlovDeclareWar.mp3          | {% include embed-audio.html src="KozlovDeclareWar.mp3" %} Vperʲod, mastʲera vojny!                                | {% include embed-audio.html src="ISV/KozlovDeclareWar.mp3" %} Idemo naprěd, majstri vojny                       |


If you’re curious to hear the results, you can [download new voice lines here](/blog/assets/audio/Kozlov_ISV.zip) and install them in your game. Just unpack everything into the `<game folder>\assets\Sounds\Speech\Shared\Koslov` directory (you might need setting `LooseFilesOverridePAK = 1` in your `config.ini` in some cases).
